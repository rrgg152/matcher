...
public abstract class ApplicationTestCase {
  ...
  protected void assertRequestAndResponse(
      String method,
      String endpoint,
      Integer expectedStatusCode,
      String expectedBody
      ...
      mockMvc
          .perform(request(HttpMethod.valueOf(method), endpoint).contentType(APPLICATION_JSON))
          .andExpect(status().is(expectedStatusCode))
          .andExpect(content().string(expectedBody));
  }
  
  protected void assertRequestAndResponseWithBody(
      String method,
      String endpoint,
      String body,
      Integer expectedStatusCode,
